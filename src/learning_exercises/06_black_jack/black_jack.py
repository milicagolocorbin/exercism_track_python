...
def higher_card(card_one, card_two):
    ...
    Returns:
        str or tuple: The resulting tuple contains both cards if
...
def value_of_ace(card_one, card_two):
    ...
    if card_one == "A" or card_two == "A":
        return 1
    if card_one not in TENS and card_two not in TENS and total < 11:
        return 11
    return 1
...
def is_blackjack(card_one, card_two):
    ...
    if card_one == "A" and card_two in TENS:
        return True
    if card_two == "A" and card_one in TENS:
        return True
    return False
