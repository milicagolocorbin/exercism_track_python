...
def preparation_time_in_minutes(number_of_layers):
    ...
    :return: int - minutes spent preparing lasagna derived from 'PREPARATION_TIME'.

    Function that takes the number of layers you want to add to the lasagna as an
    argument and returns how many minutes you would spend making them based on the
    `PREPARATION_TIME`.
    """
